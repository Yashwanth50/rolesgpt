    ...
    <div className="overflow-y-auto h-full">
      <div className="flex gap-4 pl-4 pb-4 px-4 bg-primarybg md:bg-overall border-b-2 border-b-[#E0E0E0]">
        <div className="w-full flex gap-3 h-full rounded-normal m-auto">
          <div
            className={`md:w-full w-full md:overflow-auto max-w-[1120px] mx-auto h-[100%] rounded-mid flex flex-col gap-6 md:gap-8 pt-0 md:pt-5 relative`}
          >
      ...
      <div
        className={`flex gap-4 pl-4 bg-primarybg md:bg-overall border-b-2 border-b-[#E0E0E0]`}
      >
        <div className="w-full flex gap-3 h-full rounded-normal m-auto ml-[25px] mb-[10px]">
          <div
            className={`md:w-full w-full md:overflow-auto max-w-[1120px] mx-auto h-[100%] rounded-mid flex flex-col gap-6 md:gap-8 pt-0 relative`}
          >
              ...
              <div className="flex flex-col gap-4 pt-4">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex justify-between">
                    ...
                    <div>
                      <div className="border border-[#B32C90] rounded text-[#B32C90]">
                        ...
                        {dataTagMenu && (
                          <div
                            className={`data-tag-menu bg-overall flex flex-col border-[1.5px] border-border text-primary rounded-normal items-start overflow-hidden z-[1] `}
                          >
                            <div
                              onClick={() => handleOptionClick("GPT4")}
                              className={`${
                                dataTag === "GPT4" ? "bg-hoverbg" : ""
                            ...
                            <div
                              onClick={() =>
                                handleOptionClick("Vicuña 14b llm")
                              }
                              className={`${
                                dataTag === "Vicuña 14b llm" ? "bg-hoverbg" : ""
                            ...
                            <div
                              ...
                              className={`${
                                dataTag === "Mistral llm" ? "bg-hoverbg" : ""
                              } flex flex-col items-start gap-0 w-full h-full cursor-pointer hover:bg-hoverbg p-2 px-4 text-decoration-none mx-auto`}
                            >
                              <div className="w-full flex items-center justify-between">
                                <div className="text-primary font-normal text-[14px] leading-[16.71px]">
                            ...
                            <div
                              ...
                              className={`${
                                dataTag === "Search Google" ? "bg-hoverbg" : ""
                              } flex flex-col items-start gap-0 w-full h-full cursor-pointer hover:bg-hoverbg p-2 px-4 text-decoration-none mx-auto`}
                            >
                              <div className="w-full flex items-center justify-between">
                                <div className="text-primary font-normal text-[14px] leading-[16.71px]">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div>
                      <DialogTrigger>
                        <Button className="w-fit p-2 py-0 h-[32px] text-[14px] leading-[16px] hover:text-[#BE407C] focus:outline-none border border-[#B32C90] rounded text-[#B32C90] ">
                          Know more
                        </Button>
                      </DialogTrigger>
                    </div>
                  ...
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-[14px] leading-[16px] font-[300] text-[#323232]">
                        This will permanently remove all chat histories. Once
                  ...
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-[14px] leading-[16px] font-[300] text-[#323232]">
                        Deleting all projects will erase all your project data
                        and pinned items. This process is irreversible..
                      </div>
                    </div>
                    <div>
                      <DialogTrigger>
                  ...
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-[14px] leading-[16px] font-[300] text-[#323232]">
                        This will permanently remove all researchs histories.
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-[14px] leading-[16px] font-[300] text-[#323232]">
                        Upload Microsoft Word, Excel, Powerpoint and other
                        files.
                      </div>
                    </div>
                    <div>
                  ...
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-[14px] leading-[16px] font-[300] text-[#323232]">
                        Upload Microsoft Word, Excel, PowerPoint, and other
                        files, including those from SharePoint sites.
                      </div>
                    </div>
                    <div>
                      <DialogTrigger>
            ...
            <div className="mx-auto flex flex-col gap-4 w-full md:w-full p-3">
              <div className="flex flex-col gap-4 pt-4">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-between">
                    <div className="text-[14px] leading-[16px] font-[300] text-[#323232]">
                      RolesGPT will become more helpful as you chat, picking up
                      on details and preferences to tailor its responses to you.
                    </div>
                    <div>
                      <DialogTrigger>
                        <Button className="w-fit p-2 py-0 h-[32px] text-[14px] leading-[16px] border border-[#B32C90] rounded text-[#B32C90] text-grad-2">
                  ...
                  <div className="flex mb-1">
                    <label className="text-[14px] leading-[16px] text-[#14343B80] flex gap-2 items-center">
                      <input
                        type="checkbox"
                        className="mt-[2px] w-[17.3px]"
                        style={{ accentColor: "#c95663" }}
                      />
                  ...
                  <div className="flex gap-4">
                    <div className="flex-col w-[85%]">
                      <div className="text-[14px] leading-[16px] text-[#14343B80]">
                        I am starting with Calisthenics exercises from September
                        first week
                      </div>
                    </div>
                  ...
                  <div className="flex gap-4">
                    <div className="flex-col w-[85%]">
                      <div className="text-[14px] leading-[16px] text-[#14343B80]">
                        Recall that I prefer concise answers with bullet points
                        whenever possible. I also like a casual and friendly
                        tone in responses.
                      </div>
                    </div>
                    <div className="w-[15%] flex justify-end">
